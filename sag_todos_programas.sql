-- =====================================================
--  SAG PROGRAMAS — Instalación completa (3 programas)
--  Ejecutar este archivo UNA SOLA VEZ en phpMyAdmin
--  o con: mysql -u root -p < sag_todos_programas.sql
-- =====================================================
...
-- Limpiar tablas existentes (orden inverso a dependencias FK)
...
--  PROGRAMA: sag_pipg
-- =============================================
CREATE DATABASE IF NOT EXISTS `sag_pipg`
  CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `sag_pipg`;
...
--  PROGRAMA: sag_pipa
-- =============================================
CREATE DATABASE IF NOT EXISTS `sag_pipa`
  CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `sag_pipa`;
