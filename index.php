...
$router->post('/mantenimiento/roles/save',     'MantenimientoController', 'saveRol');
$router->post('/mantenimiento/roles/delete',   'MantenimientoController', 'deleteRol');
$router->post('/mantenimiento/privilegios/save','MantenimientoController','savePrivilegios');
